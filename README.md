## async_comm (noetic) - 0.2.1-2

The packages in the `async_comm` repository were released into the `noetic` distro by running `/usr/bin/bloom-release async_comm --rosdistro noetic` on `Tue, 02 Feb 2021 01:01:52 -0000`
...
## async_comm (melodic) - 0.2.1-2

The packages in the `async_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release async_comm --rosdistro melodic` on `Tue, 02 Feb 2021 00:57:23 -0000`
...
## async_comm (melodic) - 0.2.1-1

The packages in the `async_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release async_comm --rosdistro melodic` on `Thu, 21 Jan 2021 05:45:08 -0000`
...
## async_comm (kinetic) - 0.2.1-3

The packages in the `async_comm` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release async_comm --rosdistro kinetic` on `Thu, 21 Jan 2021 05:41:33 -0000`
...
## async_comm (kinetic) - 0.2.1-2

The packages in the `async_comm` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release async_comm --rosdistro kinetic` on `Thu, 21 Jan 2021 05:35:02 -0000`
...
## async_comm (kinetic) - 0.2.1-1

The packages in the `async_comm` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release async_comm --rosdistro kinetic` on `Thu, 21 Jan 2021 05:28:29 -0000`
...
## async_comm (melodic) - 0.2.0-1

The packages in the `async_comm` repository were released into the `melodic` distro by running `/usr/bin/bloom-release async_comm --rosdistro melodic` on `Mon, 16 Mar 2020 21:57:19 -0000`
...
## async_comm (kinetic) - 0.2.0-1

The packages in the `async_comm` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release async_comm --rosdistro kinetic` on `Mon, 16 Mar 2020 21:53:46 -0000`
